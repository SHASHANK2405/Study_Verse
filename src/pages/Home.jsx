  ...
  return (
    <div>
        ...
        <div className='w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7 mx-auto'>
          <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
              <div className='text-4xl font-semibold w-[45%]'>
                ...
                <HighlightText text={"Jod that is in demand"}></HighlightText>
              </div>
              <div className='flex flex-col gap-10 w-[40%] items-start '>
                <div className='text-[16px]'>
                  The Modern PadhaiKrlo is the dictates its own terms. Todeay, to be a comppetitve
                  specialist requires are the professional skills
                </div>
                <CTAButton active={true} linkto={"/signup"}>
                  <div>
                    Learn more
      ...
      <div className='w-11/12 mx-auto max-w-maxContent flex flex-col items-center justify-center gap-8 first-letter bg-richblack-900 text-white'>
          ...
          <h2 className='text-center text-4xl font-semibold mt-10'>review and heading</h2>
          <ReviewSlider />
      </div>
