            ...
            <div className="max-w-[500px] p-4 lg:p-8">
                ...
                <form onSubmit={handleOnSubmit}>
                    <label className='relative'>
                        <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5">New Password <span className='text-pink-200'>*</span> </p>
                        <input
                            required
                    ...
                    <label className="relative mt-3 block">
                        <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5"> Confirm New Password <span className='text-pink-200'>*</span> </p>
                        <input
                            required
